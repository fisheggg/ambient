...
def parse_arguments():
    ...
    parser.add_argument("x", default=1.0, type=float, help="x coordinate.")
    parser.add_argument("y", default=0.0, type=float, help="y coordinate.")
    parser.add_argument("z", default=0.0, type=float, help="z coordinate.")
    parser.add_argument("output_fn", help="Output file.")
    parser.add_argument(
        "--use_hrtfs", action="store_true", help="Whether to use hrtfs."
    )
